...
_G.SchemeColor = Color3.fromRGB(255, 255, 0)
_G.Background = Color3.fromRGB(25, 25, 25)
_G.Header = Color3.fromRGB(41,41, 41)
_G.TextColor = Color3.fromRGB(255, 255, 0)
_G.BorderColor3 = Color3.fromRGB(255, 255, 0)
_G.BorderSizePixel = 4
local library = {
	themes = {
        original = {
...
function library:CreateWindow(title,theme,closebind)
	...
	TapBar.BorderColor3 = Color3.fromRGB(255, 255, 0)
    TapBar.BorderSizePixel = 3
		...
		function SectionContent:CreateSection(title)
            ...
            function Content:CreateDropdown(title,list,callback)
				...
				for i,v in next, list do
					...
					DrioBy.BorderColor3 = Color3.fromRGB(255, 255, 0)
					DrioBy.BorderSizePixel = 3
